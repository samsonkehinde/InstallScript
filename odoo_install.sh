...
pip3 install -r https://raw.githubusercontent.com/odoo/odoo/13.0/requirements.txt
...
su root -c "echo 'sudo -u $OE_USER $OE_HOME_EXT/odoo-bin --config=/etc/${OE_CONFIG}.conf' >> $OE_HOME_EXT/start.sh"
